...
public class ApplicationTest extends NsTest {
    ...
    class AllFeatureTest {
        ...
        @Test
        void 중복된_메뉴_혹은_못_먹는_음식이_선택_되더라도_추가적으로_메뉴를_다시_선택해서_진행된다() {
            assertTimeoutPreemptively(RANDOM_TEST_TIMEOUT, () -> {
                final Executable executable = () -> {
                    runException("구구,제임스", "김밥", "떡볶이");
                ...
                assertRandomTest(executable,
                        ...
                        Mocking.ofShuffle(
                                ...
                                // 화요일
                                List.of("김치찌개", "김밥", "쌈밥", "된장찌개", "비빔밥", "칼국수", "불고기", "떡볶이", "제육볶음"),    // 구구(중복된 메뉴로 실패)
                                List.of("김밥", "쌈밥", "된장찌개", "비빔밥", "칼국수", "불고기", "떡볶이", "제육볶음", "김치찌개"),    // 구구(못 먹는 메뉴로 실패)
                                List.of("쌈밥", "된장찌개", "비빔밥", "칼국수", "불고기", "떡볶이", "제육볶음", "김치찌개", "김밥"),    // 구구
                                List.of("김치찌개", "쌈밥", "된장찌개", "비빔밥", "칼국수", "불고기", "떡볶이", "제육볶음", "김밥"),    // 제임스
